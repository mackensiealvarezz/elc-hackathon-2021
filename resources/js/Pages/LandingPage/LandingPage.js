        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
            ...
            <div className="w-full h-full">
                <div className="mt-10">
                    ...
                    >
                        <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:-translate-y-10 lg:translate-x-8">
...
LandingPage.layout = page => <Layout children={page} title="Welcome" />
